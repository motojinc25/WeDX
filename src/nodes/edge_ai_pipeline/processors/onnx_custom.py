...
from models.onnx_custom.model import CustomClassification
...
class EdgeAINode(BaseNode):
    def __init__(self, settings, logger=logging.getLogger(__name__)):
        ...
        self.configs = {}
        self.configs["models"] = {
            "ONNX Custom Classification": CustomClassification,
        }
        ...
        self.forms = {}
        self.forms["model"] = {}
        self.forms["input_shape_row"] = {}
        self.forms["input_shape_column"] = {}
        self.forms["input_dtype"] = {}
        self.forms["output_item_count"] = {}
    ...
    def add_node(self, parent, node_id, pos):
        ...
        self.forms["input_shape_row"][dpg_node_tag] = "224"
        self.forms["input_shape_column"][dpg_node_tag] = "224"
        self.forms["input_dtype"][dpg_node_tag] = "float32"
        self.forms["output_item_count"][dpg_node_tag] = "2"
        ...
        if self.settings["gui"]:
            ...
            with dpg.file_dialog(
                ...
                default_path=os.path.abspath(
                    os.path.join(current_path, "../../../models/onnx_mobilenetv3small")
                ),
            ...
            with dpg.node(
                ...
                with dpg.node_attribute(attribute_type=int(Attribute.STATIC)):
                    dpg.add_input_text(
                        label="Input Shape(Row)",
                        no_spaces=True,
                        width=self.settings["node_width"] - 130,
                        default_value=self.forms["input_shape_row"][dpg_node_tag],
                        tag=dpg_node_tag + ":input_shape_row",
                    )
                    dpg.add_input_text(
                        label="Input Shape(Column)",
                        no_spaces=True,
                        width=self.settings["node_width"] - 130,
                        default_value=self.forms["input_shape_column"][dpg_node_tag],
                        tag=dpg_node_tag + ":input_shape_column",
                    )
                ...
                with dpg.node_attribute(attribute_type=int(Attribute.STATIC)):
                    dpg.add_input_text(
                        ...
                        no_spaces=True,
                        width=self.settings["node_width"] - 130,
                        default_value=self.forms["input_dtype"][dpg_node_tag],
                        tag=dpg_node_tag + ":input_dtype",
                    )

                # Add a Output Item Count
                with dpg.node_attribute(attribute_type=int(Attribute.STATIC)):
                    dpg.add_input_text(
                        label="Output Item Count",
                        no_spaces=True,
                        width=self.settings["node_width"] - 130,
                        default_value=self.forms["output_item_count"][dpg_node_tag],
                        tag=dpg_node_tag + ":output_item_count",
                    )
    ...
    def get_export_params(self, node_id):
        ...
        params["input_shape_row"] = self.forms["input_shape_row"][dpg_node_tag]
        params["input_shape_column"] = self.forms["input_shape_column"][dpg_node_tag]
        params["input_dtype"] = self.forms["input_dtype"][dpg_node_tag]
        params["output_item_count"] = self.forms["output_item_count"][dpg_node_tag]
        return params

    def set_import_params(self, node_id, params):
        dpg_node_tag = str(node_id) + ":" + self.name.lower().replace(" ", "_")
        self.forms["model"][dpg_node_tag] = params["model"]
        self.forms["input_shape_row"][dpg_node_tag] = params["input_shape_row"]
        self.forms["input_shape_column"][dpg_node_tag] = params["input_shape_column"]
        self.forms["input_dtype"][dpg_node_tag] = params["input_dtype"]
        self.forms["output_item_count"][dpg_node_tag] = params["output_item_count"]
        if self.settings["gui"]:
        ...
        if dpg_node_tag in self.configs["model_filepaths"]:
            ...
            self.configs["instances"][dpg_node_tag].connect(
                ...
                input_shape=(
                    int(self.forms["input_shape_row"][dpg_node_tag]),
                    int(self.forms["input_shape_column"][dpg_node_tag]),
                ),
                input_dtype=self.forms["input_dtype"][dpg_node_tag],
                output_item_count=int(self.forms["output_item_count"][dpg_node_tag]),
            )
            if self.configs["instances"][dpg_node_tag].is_connect():
                ...
                if self.settings["gui"]:
                    ...
                    dpg.disable_item(dpg_node_tag + ":input_shape_row")
                    dpg.disable_item(dpg_node_tag + ":input_shape_column")
                    dpg.disable_item(dpg_node_tag + ":input_dtype")
                    dpg.disable_item(dpg_node_tag + ":output_item_count")
    ...
    def callback_button_connect(self, sender, data, user_data):
        ...
        self.forms["input_shape_row"][dpg_node_tag] = dpg.get_value(dpg_node_tag + ":input_shape_row")
        self.forms["input_shape_column"][dpg_node_tag] = dpg.get_value(dpg_node_tag + ":input_shape_column")
        self.forms["input_dtype"][dpg_node_tag] = dpg.get_value(dpg_node_tag + ":input_dtype")
        self.forms["output_item_count"][dpg_node_tag] = dpg.get_value(dpg_node_tag + ":output_item_count")
        if (
                ...
                if dpg_node_tag in self.configs["model_filepaths"]:
                    self.configs["instances"][dpg_node_tag].connect(
                        ...
                        output_item_count=int(
                            self.forms["output_item_count"][dpg_node_tag]
                        ),
                    )
            if self.configs["instances"][dpg_node_tag].is_connect():
                dpg.set_item_label(
            ...
            dpg.enable_item(dpg_node_tag + ":input_shape_row")
            dpg.enable_item(dpg_node_tag + ":input_shape_column")
            dpg.enable_item(dpg_node_tag + ":input_dtype")
            dpg.enable_item(dpg_node_tag + ":output_item_count")
            dpg.hide_item(dpg_node_tag + ":modelfileNetron")
